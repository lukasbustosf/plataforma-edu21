...
async function agregarActividadesFaltantes() {
  try {
    console.log('🚀 Agregando actividades faltantes de medios de transporte...\n');
    ...
    // Datos de las 3 actividades faltantes
